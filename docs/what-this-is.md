...
- **Evidence and assurance gates** — validators, git hooks, calibration-gated blind verification, and mutation-tested enforcement (mutation-tested in the development repository; `scripts/bake-and-test.cjs` ships as the effectiveness proof a reader can run).
