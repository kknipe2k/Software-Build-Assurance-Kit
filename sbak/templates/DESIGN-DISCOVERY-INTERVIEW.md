...
1. **Synthesize into the 9 sections** of `sbak/templates/design.md`, replacing every `{{placeholder}}` with a concrete value. No placeholders left in the instance file.
