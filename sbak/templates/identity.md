...
See `LICENSE`, `CONTRIBUTING.md` if present.
...
| 3 | `sbak/BUILD-PLAYBOOK.md` | The methodology — four layers, three constraints, per-stage loop |
| 4 | `sbak/persistence-architecture.md` | The layer model — where each artifact lives, who reads/writes when |
| 5 | `sbak/PROCESS-VALIDATION.md` | The scoring framework — three axes, threshold gates, outcome matrix |
