...
*Paired with `BUILD-PLAYBOOK.md` (the ladder definition), `release.yml` (the SLSA attestation), and gate **G15** / **G16** (`validators/validate-transition.cjs` / `validate-release-readiness.cjs`).*
