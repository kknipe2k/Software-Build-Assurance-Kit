...
This directory holds **per-stage retrospectives** that Claude fills in for every milestone-stage session. They're how the project tests its build pattern (per `PROCESS-VALIDATION.md` at repo root).
...
Framework reference: `PROCESS-VALIDATION.md` (repo root) — three-axis scoring, threshold gates, outcome matrix.
...
The framework lives in `PROCESS-VALIDATION.md` at repo root. This directory is where the actual filled-in retrospectives accumulate as the project progresses.
